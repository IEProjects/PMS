            ...
            <div v-if="addTaskView" >
                <div class="panel panel-primary">
                    <div class="panel-heading text-center">
                        <h2 class="text-default"><i class="glyphicon glyphicon-pencil"></i>New Task</h2>
                        <!-- <h2 class="text-default"><i class="glyphicon glyphicon-pencil"></i> @{{ editTaskView ? 'Update' : 'New'}} Key Result</h2> -->
                    </div>
                    <div class="panel-body">
                        <div class="col-lg-12">
                            <div class="form-group">
                                <input class="form-control" type="text" v-model="newTask.title" value="" placeholder="Task title">
                                <span v-show="newTask.title==''" class="text-danger">* Title Required!</span>
                            </div>
                            <div class="form-group">
            ...
            <div v-else>
                <div v-if="pendingAndCompleteTasksView">
                    <div class="panel panel-default">
                        <div class="panel-heading text-center">
                            <h2 class="text-info" ><i class="glyphicon glyphicon-list-alt"></i> Tasks</h2>
                            <!-- <h2 class="text-info" ><i class="glyphicon glyphicon-list-alt"></i> Keyresults(@{{pendingAndComplete}})</h2> -->
                        </div>
                        <div class="panel-body">
                            ...
                            <div :class="pending ? 'col-lg-6':'col-lg-12'" v-if="complete">
                                <div class="panel panel-success">
                                    <div class="panel-body">
                                        <h4 class="text-success"><i class="glyphicon glyphicon-check"></i> Weekly Planner</h4>
                                        <!-- <h4 class="text-success"><i class="glyphicon glyphicon-check"></i> Planner(@{{complete}})</h4> -->
...
<br>
                                        ...
                                        <button type="button" class="btn btn-warning btn-sm "style="float: right;">Send to basecamp <span class="glyphicon glyphicon-envelop"></span></button>
                                    </div>
